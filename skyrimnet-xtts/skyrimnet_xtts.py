...
def generate_audio(model_choice:str=None, text:str=None, language:str="en", speaker_audio:str=None, prefix_audio:str=None,
                  ...
                  min_k:float=None, min_p:float=None, linear:float=None, confidence:float=None, quadratic:float=None, seed:int=None, randomize_seed:bool=None, unconditional_keys:str | list | None=None
                  ) -> tuple[Path, int]:
    """
...
if __name__ == "__main__":
    ...
    CURRENT_MODEL = initialize_model_with_cache(device=args.device, use_deepspeed=args.deepspeed, use_bfloat16=args.use_bfloat16)
