...
import COQUI_AI_TTS.vc.layers.freevc.modules as modules
from COQUI_AI_TTS.tts.layers.vits.discriminator import DiscriminatorS
from COQUI_AI_TTS.tts.utils.helpers import sequence_mask
from COQUI_AI_TTS.tts.utils.speakers import SpeakerManager
from COQUI_AI_TTS.utils.voices import CloningMixin
from COQUI_AI_TTS.vc.configs.freevc_config import FreeVCConfig
from COQUI_AI_TTS.vc.layers.freevc.commons import init_weights, rand_slice_segments
from COQUI_AI_TTS.vc.layers.freevc.mel_processing import mel_spectrogram_torch
from COQUI_AI_TTS.vc.layers.freevc.speaker_encoder.speaker_encoder import SpeakerEncoder as SpeakerEncoderEx
from COQUI_AI_TTS.vc.layers.freevc.wavlm import get_wavlm
from COQUI_AI_TTS.vc.models.base_vc import BaseVC
from COQUI_AI_TTS.vocoder.models.hifigan_discriminator import DiscriminatorP
...
class FreeVC(CloningMixin, BaseVC):
    ...
    Examples:
        >>> from COQUI_AI_TTS.vc.configs.freevc_config import FreeVCConfig
        >>> from COQUI_AI_TTS.vc.models.freevc import FreeVC
        >>> config = FreeVCConfig()
        >>> model = FreeVC(config)
    """
