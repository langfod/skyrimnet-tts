...
from COQUI_AI_TTS.tts.layers.vits.networks import PosteriorEncoder
from COQUI_AI_TTS.tts.utils.speakers import SpeakerManager
from COQUI_AI_TTS.utils.audio.torch_transforms import wav_to_spec
...
from COQUI_AI_TTS.vc.models.freevc import Generator, ResidualCouplingBlock
