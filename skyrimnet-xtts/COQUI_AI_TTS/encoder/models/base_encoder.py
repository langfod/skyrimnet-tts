...
# Training utility not needed for inference
from COQUI_AI_TTS.model import load_fsspec  # Local replacement

from COQUI_AI_TTS.encoder.losses import AngleProtoLoss, GE2ELoss, SoftmaxAngleProtoLoss
...
class BaseEncoder(nn.Module):
    ...
    def load_checkpoint(
        ...
        try:
            ...
            model_dict = load_state_dict(model_dict, state["model"], config)
