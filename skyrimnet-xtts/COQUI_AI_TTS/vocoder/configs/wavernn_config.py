...
from COQUI_AI_TTS.vocoder.models.wavernn import WavernnArgs
...
class WavernnConfig(BaseVocoderConfig):
    ...
    Args:
        ...
        mulaw (bool):
            ...
            to `True`.
        generator_model (str):
            One of the generators from COQUI_AI_TTS.vocoder.models.*`. Every other non-GAN vocoder model is
