...
from COQUI_AI_TTS.vocoder.configs.shared_configs import BaseVocoderConfig
from COQUI_AI_TTS.vocoder.models.wavegrad import WavegradArgs
...
class WavegradConfig(BaseVocoderConfig):
    ...
    Example:
        ...
        >>> from COQUI_AI_TTS.vocoder.configs import WavegradConfig
        >>> config = WavegradConfig()

    Args:
        model (str):
            Model name used for selecting the right model at initialization. Defaults to `wavegrad`.
        generator_model (str): One of the generators from COQUI_AI_TTS.vocoder.models.*`. Every other non-GAN vocoder model is
