...
from COQUI_AI_TTS.vocoder.datasets.gan_dataset import GANDataset
from COQUI_AI_TTS.vocoder.layers.losses import DiscriminatorLoss, GeneratorLoss
from COQUI_AI_TTS.vocoder.models import setup_discriminator, setup_generator
...
class GAN(BaseVocoder):
    def __init__(self, config: Coqpit, ap: AudioProcessor = None):
        ...
        Examples:
            ...
            >>> from COQUI_AI_TTS.vocoder.configs import HifiganConfig
