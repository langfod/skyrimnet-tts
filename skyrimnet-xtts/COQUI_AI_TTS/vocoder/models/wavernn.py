...
from COQUI_AI_TTS.vocoder.layers.losses import WaveRNNLoss
from COQUI_AI_TTS.vocoder.layers.upsample import Stretch2d
from COQUI_AI_TTS.vocoder.models.base_vocoder import BaseVocoder
from COQUI_AI_TTS.vocoder.utils.distribution import sample_from_discretized_mix_logistic, sample_from_gaussian
...
class Wavernn(BaseVocoder):
    def __init__(self, config: Coqpit):
        ...
        Examples:
            >>> from COQUI_AI_TTS.vocoder.configs import WavernnConfig
