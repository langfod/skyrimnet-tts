...
from COQUI_AI_TTS.tts.configs.shared_configs import BaseTTSConfig, CapacitronVAEConfig, GSTConfig
...
class TacotronConfig(BaseTTSConfig):
    ...
    Example:
        ...
        >>> from COQUI_AI_TTS.tts.configs.tacotron_config import TacotronConfig
