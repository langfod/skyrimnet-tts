...
from COQUI_AI_TTS.utils.manage import get_user_data_dir  # Local replacement

from COQUI_AI_TTS.tts.configs.shared_configs import BaseTTSConfig
from COQUI_AI_TTS.tts.layers.bark.model import GPTConfig
from COQUI_AI_TTS.tts.layers.bark.model_fine import FineGPTConfig
from COQUI_AI_TTS.tts.models.bark import BarkAudioConfig
