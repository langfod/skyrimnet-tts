...
from COQUI_AI_TTS.tts.layers.align_tts.mdn import MDNBlock
from COQUI_AI_TTS.tts.layers.feed_forward.decoder import Decoder
from COQUI_AI_TTS.tts.layers.feed_forward.duration_predictor import DurationPredictor
...
class AlignTTS(BaseTTS):
    ...
    Examples:
        >>> from COQUI_AI_TTS.tts.configs.align_tts_config import AlignTTSConfig
    ...
    def get_criterion(self):
        from COQUI_AI_TTS.tts.layers.losses import AlignTTSLoss  # pylint: disable=import-outside-toplevel
