...
from COQUI_AI_TTS.model import load_fsspec  # Local replacement
# Training samplers not needed for inference
# Training utilities not needed for inference

from COQUI_AI_TTS.tts.configs.shared_configs import CharactersConfig
from COQUI_AI_TTS.tts.datasets.dataset import TTSDataset, _parse_sample, get_attribute_balancer_weights
from COQUI_AI_TTS.tts.layers.glow_tts.duration_predictor import DurationPredictor
from COQUI_AI_TTS.tts.layers.vits.discriminator import VitsDiscriminator
from COQUI_AI_TTS.tts.layers.vits.networks import PosteriorEncoder, ResidualCouplingBlocks, TextEncoder
from COQUI_AI_TTS.tts.layers.vits.stochastic_duration_predictor import StochasticDurationPredictor
from COQUI_AI_TTS.tts.models.base_tts import BaseTTS
from COQUI_AI_TTS.tts.utils.fairseq import rehash_fairseq_vits_checkpoint
from COQUI_AI_TTS.tts.utils.helpers import generate_path, rand_segments, segment, sequence_mask
from COQUI_AI_TTS.tts.utils.languages import LanguageManager
from COQUI_AI_TTS.tts.utils.speakers import SpeakerManager
from COQUI_AI_TTS.tts.utils.text.characters import BaseCharacters, BaseVocabulary, _characters, _pad, _phonemes, _punctuations
from COQUI_AI_TTS.tts.utils.text.tokenizer import TTSTokenizer
from COQUI_AI_TTS.tts.utils.visual import plot_alignment
from COQUI_AI_TTS.utils.audio.torch_transforms import spec_to_mel, wav_to_mel, wav_to_spec
from COQUI_AI_TTS.utils.samplers import BucketBatchSampler
from COQUI_AI_TTS.vocoder.models.hifigan_generator import HifiganGenerator
from COQUI_AI_TTS.vocoder.utils.generic_utils import plot_results
...
class Vits(BaseTTS):
    ...
    def get_criterion(self):
        ...
        `train_step()`"""
        from COQUI_AI_TTS.tts.layers.losses import (  # pylint: disable=import-outside-toplevel
    ...
    def load_fairseq_checkpoint(self, config, checkpoint_dir, eval=False, strict=True):  # pylint: disable=unused-argument, redefined-builtin
        ...
        from COQUI_AI_TTS.tts.utils.text.cleaners import basic_cleaners
