...
# Training-only imports replaced with minimal stubs for inference deployment
from COQUI_AI_TTS.model import BaseDashboardLogger, DistributedSampler, DistributedSamplerWrapper
...
class BaseTTS(CloningMixin, torch.nn.Module):
