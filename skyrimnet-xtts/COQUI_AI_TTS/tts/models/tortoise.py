...
from COQUI_AI_TTS.tts.layers.tortoise.arch_utils import TorchMelSpectrogram
from COQUI_AI_TTS.tts.layers.tortoise.audio_utils import (
    denormalize_tacotron_mel,
    load_required_audio,
    wav_to_univnet_mel,
)
from COQUI_AI_TTS.tts.layers.tortoise.autoregressive import UnifiedVoice
from COQUI_AI_TTS.tts.layers.tortoise.classifier import AudioMiniEncoderWithClassifierHead
from COQUI_AI_TTS.tts.layers.tortoise.clvp import CLVP
from COQUI_AI_TTS.tts.layers.tortoise.diffusion import SpacedDiffusion, get_named_beta_schedule, space_timesteps
from COQUI_AI_TTS.tts.layers.tortoise.diffusion_decoder import DiffusionTts
from COQUI_AI_TTS.tts.layers.tortoise.random_latent_generator import RandomLatentConverter
from COQUI_AI_TTS.tts.layers.tortoise.tokenizer import VoiceBpeTokenizer
from COQUI_AI_TTS.tts.layers.tortoise.vocoder import VocConf, VocType
from COQUI_AI_TTS.tts.layers.tortoise.wav2vec_alignment import Wav2VecAlignment
from COQUI_AI_TTS.tts.models.base_tts import BaseTTS
from COQUI_AI_TTS.utils.generic_utils import (
...
class Tortoise(BaseTTS):
    ...
    Examples:
        >>> from COQUI_AI_TTS.tts.configs.tortoise_config import TortoiseConfig
        >>> from COQUI_AI_TTS.tts.models.tortoise import Tortoise
