...
from COQUI_AI_TTS.model import load_fsspec  # Use local load_fsspec replacement

from COQUI_AI_TTS.tts.configs.shared_configs import BaseTTSConfig
from COQUI_AI_TTS.tts.layers.xtts.gpt import GPT
from COQUI_AI_TTS.tts.layers.xtts.hifigan_decoder import HifiDecoder
from COQUI_AI_TTS.tts.layers.xtts.stream_generator import init_stream_support
from COQUI_AI_TTS.tts.layers.xtts.tokenizer import VoiceBpeTokenizer, split_sentence
from COQUI_AI_TTS.tts.layers.xtts.xtts_manager import LanguageManager, SpeakerManager
