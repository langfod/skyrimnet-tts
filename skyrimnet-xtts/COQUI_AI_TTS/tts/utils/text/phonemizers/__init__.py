from COQUI_AI_TTS.tts.utils.text.phonemizers.base import BasePhonemizer
from COQUI_AI_TTS.tts.utils.text.phonemizers.belarusian_phonemizer import BEL_Phonemizer
from COQUI_AI_TTS.tts.utils.text.phonemizers.espeak_wrapper import ESpeak
from COQUI_AI_TTS.tts.utils.text.phonemizers.gruut_wrapper import Gruut

try:
    from COQUI_AI_TTS.tts.utils.text.phonemizers.bangla_phonemizer import BN_Phonemizer
except ImportError:
    BN_Phonemizer = None

try:
    from COQUI_AI_TTS.tts.utils.text.phonemizers.ja_jp_phonemizer import JA_JP_Phonemizer
except ImportError:
    JA_JP_Phonemizer = None

try:
    from COQUI_AI_TTS.tts.utils.text.phonemizers.ko_kr_phonemizer import KO_KR_Phonemizer
except ImportError:
    KO_KR_Phonemizer = None

try:
    from COQUI_AI_TTS.tts.utils.text.phonemizers.zh_cn_phonemizer import ZH_CN_Phonemizer
except ImportError:
